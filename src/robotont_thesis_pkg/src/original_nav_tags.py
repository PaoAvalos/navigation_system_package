...
# AR_Recovery = rospy.get_param("AR_Recovery")
# AR_Adjustment = rospy.get_param("AR_Adjustment")

# AR_Req = AR_Recovery or AR_Adjustment # if either of them is true, AR_Req is true
# print("AR_Req: ", AR_Req)

def callback(data):
        global last_heartbeat, marker_ids, k, param, twist_msg, cmd_vel_pub, finish, distance_achieved, AR_Req, AR_Recovery,AR_Adjustment
...
def ar_demo():
        ...
        # while True:
        #         start = input("enter anything to start (or 'q' to quit): ")
        #         if start.lower() == 'q':
        #                 break
        
        try:
                global marker_ids , AR_Adjustment, AR_Req, AR_Recovery
